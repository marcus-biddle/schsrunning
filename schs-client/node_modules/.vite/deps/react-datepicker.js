...
var Tt = function(t3) {
  ...
  function n() {
    ...
    return ve(ke(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { dropdownVisible: false }), ve(ke(t4), "renderSelectOptions", function() {
      ...
      return import_react2.default.createElement("select", { value: getTime(Qe(t4.props.date)), className: "react-datepicker__month-year-select", onChange: t4.onSelectChange }, t4.renderSelectOptions());
    }), ve(ke(t4), "renderReadView", function(r3) {
  ...
  function o() {
    ...
    return ve(ke(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Ce(Array(12)).map(function() {
      ...
      if ("Tab" !== d3 && e3.preventDefault(), !s4) {
        var u2 = Wt(p, i3), h3 = Qt[u2].verticalNavigationOffset, m3 = Qt[u2].grid;
        switch (d3) {
          case "Enter":
      ...
      var r2 = t4.props, n2 = r2.showFullMonthYearPicker, o2 = r2.renderMonthContent, a4 = r2.locale, s4 = rt(e3, a4), i3 = tt(e3, a4);
      return o2 ? o2(e3, s4, i3) : n2 ? i3 : s4;
    }), ve(ke(t4), "getQuarterContent", function(e3) {
      var r2 = t4.props, n2 = r2.renderQuarterContent, o2 = nt(e3, r2.locale);
...
ve(Ht, "calcCenterPosition", function(e3, t3) {
...
var Vt = function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ve(ke(a3 = n.call(this, t4)), "YEAR_REFS", Ce(Array(a3.props.yearItemNumber)).map(function() {
      ...
      var t5 = We(setYear(a3.props.date, e3));
      return !a3.props.disabledKeyboardNavigation && !a3.props.inline && !ze(t5, We(a3.props.selected)) && ze(t5, We(a3.props.preSelection));
    }), ve(ke(a3), "onYearClick", function(e3, t5) {
      var r2 = a3.props.date;
      a3.handleYearClick(We(setYear(r2, t5)), e3);
...
var $t = function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ve(ke(a3 = n.call(this, t4)), "handleClickOutside", function(e3) {
      ...
      if (!a3.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a3.props.showYearPicker:
            t5 = function(e3) {
              var t6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t6.minDate, n3 = t6.yearItemNumber, o3 = void 0 === n3 ? 12 : n3, a4 = _t(We(subYears(e3, o3)), o3).endPeriod, s4 = r3 && getYear(r3);
      ...
      a3.props.onSelect(He(), e3), a3.props.setPreSelection && a3.props.setPreSelection(He());
